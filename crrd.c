 ...
 * returns the start of the period for the specific time. Published for
 * testing purposes only.
 */ 
static rrdt_t find_period(rrdt_t time, rrdt_t tperiod) {
    rrdt_t rem;
    rrdt_t start;
 ...
 */
static void rrd_store(rrd_t *r, void *v) {
